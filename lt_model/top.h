...
class top : public sc_module {
    public:
        ...
        sc_vector<sc_signal<bool >> done_with_clause_signal;
        sc_vector<sc_signal<bool >> done_with_unit_clause_signal;
        sc_vector<sc_signal<bool >> conflict_signal;
        // sc_signal<bool > *done_with_clause_signal[NUMBER_OF_ENGINE];
        // sc_signal<bool > *done_with_unit_clause_signal[NUMBER_OF_ENGINE];
        // sc_signal<bool > *conflict_signal;

        sc_fifo<int > *engine_output_unit_clause_fifo[NUMBER_OF_ENGINE]; //depth == N
        sc_fifo<int > *engine_input_unit_clause_fifo[NUMBER_OF_ENGINE]; //depth == # of var kind
        ...
        void print_all_engine_input_clause_fifo();
